...
%% load data
angles = importdata([pwd,'/data/vesicle/vesicle3_angles.mat']);
projections  = importdata([pwd,'/data/vesicle/vesicle3_projections.mat']);
...
%% FRC curve
model = readMRC('data/vesicle/vesicle.mrc');
